...
HB_FUNC( MAPISENDMAIL )
{
   ...
   orig.lpszName           = ( LPTSTR ) hb_parcx( 4 ) ;  // Originator's Name
   orig.lpszAddress        = ( LPTSTR ) hb_parcx( 5 ) ;  // Originators Address
   ...
   rcpt.lpszName           = ( LPTSTR ) hb_parcx( 6 ) ;  // Reciepient's Name, e.g., vouchcac@hotmail.com
   rcpt.lpszAddress        = ( LPTSTR ) hb_parcx( 7 ) ;  // Reciepient's Address
   ...
   mssg.lpszSubject        = ( LPTSTR ) hb_parcx( 2 ) ;  // Message Subject
   mssg.lpszNoteText       = ( LPTSTR ) hb_parcx( 3 ) ;  // Message Text
